...
async function fixStoragePermissions() {
  ...
  if (!adminClient) {
    ...
    const sql = fs.readFileSync(path.join(__dirname, 'supabase/migrations/20250521000000_fix_storage_permissions.sql'), 'utf8');
...
`;
    ...
    fs.writeFileSync('src/DemoFixProvider.jsx', fixComponentCode);
    console.log('Created src/DemoFixProvider.jsx - add this component to App.tsx to enable demo mode');
