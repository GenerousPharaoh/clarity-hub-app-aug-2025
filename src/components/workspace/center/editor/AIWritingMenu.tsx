...
export function AIWritingMenu({ editor, onClose }: AIWritingMenuProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-20 z-50 mx-auto w-80 rounded-xl border border-surface-200 bg-white p-3 shadow-2xl dark:border-surface-600 dark:bg-surface-800">
      {/* Header */}
