...
export function DashboardPage() {
  ...
  const lastOpenedProjectId = workspaceSession?.projectId ?? null;
  ...
  // Skeleton: just project cards, no hero/metrics
  if (isLoading) {
    return (
      <div className="relative min-h-full bg-white dark:bg-surface-950">
        <div className="mx-auto max-w-7xl px-5 py-4 sm:px-8 lg:px-10">
          {/* Compact header skeleton */}
          <div className="flex items-center justify-between">
            <div className="h-7 w-48 animate-pulse rounded-lg bg-surface-100 dark:bg-surface-800" />
            <div className="h-10 w-28 animate-pulse rounded-xl bg-surface-100 dark:bg-surface-800" />
          </div>
          {/* Search skeleton */}
          <div className="mt-4 h-10 w-52 animate-pulse rounded-xl bg-surface-100 dark:bg-surface-800" />
          {/* Card skeletons */}
  ...
  return (
    <div className="relative min-h-full bg-white dark:bg-surface-950">
      <div className="mx-auto max-w-7xl px-5 py-4 sm:px-8 lg:px-10">
        ...
        {/* Compact header: greeting left, new matter button right */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="font-heading text-xl font-bold tracking-tight text-surface-900 dark:text-surface-100">
        ...
        {/* Error state */}
        {error && (
          <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-red-200 bg-red-50/80 p-5 dark:border-red-800/50 dark:bg-red-950/30 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
